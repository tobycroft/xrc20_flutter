...
import 'package:xrc20_flutter/config/url.dart';
...
import 'package:xrc20_flutter/config/res.dart';
import 'package:xrc20_flutter/tuuz/alert/ios.dart';
import 'package:xrc20_flutter/tuuz/button/button.dart';
        ...
        child: Container(
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage(Res().Login_BG), fit: BoxFit.cover)),
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  if (json["code"] == 0) {
                    ...
                    Storage()
                        .Set("__token__", json["data"]["token"].toString());
                    Alert().Confirm(
                        context,
                        "登录成功",
                        json["data"]["uid"].toString() + "欢迎回来！",
